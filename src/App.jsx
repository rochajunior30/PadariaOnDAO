...
const App = () => {
  ...
  const editionDrop = useEditionDrop("0x7025c9452d24520bD4c5B3DF90b3348BB79bfe90");
  const token = useToken("0x61a54DBF9ba636245D82a6EDACCF48fe613EaF2b");
  const vote = useVote("0xe1a72D7532Fc447265E4E570e1C8828F2431A871");
  ...
  if (!address) {
    return (
      <div className="landing">
        ...
        <button onClick={connectWithMetamask} className="button">
