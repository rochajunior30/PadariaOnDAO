...
(async () => {
  try {
    const voteContractAddress = await sdk.deployer.deployVote({
      ...
      name: "Padaria Online - DAO - A DAO dos empreendedores coletivos. Gerenciando soluções coletivamente!",

      // Essa a localização do seu token de governança, nosso contrato ERC-20!
      voting_token_address: "0x61a54DBF9ba636245D82a6EDACCF48fe613EaF2b",
